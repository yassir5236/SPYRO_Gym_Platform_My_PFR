...
Route::get('gallery-images/guest', [GalleryImageController::class, 'index'])->name('gallery-images.index');
...
Route::middleware(['auth', 'admin'])->group(function () {
    Route::get('/products/admin', [ProductController::class, 'index'])->name('products.admin');
    ...
    Route::get('/posts/admin', [PostController::class, 'index'])->name('posts.indexAdmin');
...
Route::middleware(['auth', 'user'])->group(function () {
    ...
    Route::get('/posts/client', [PostController::class, 'index'])->name('posts.indexClient');
    Route::get('/subscriptions/test/client', [SubscriptionController::class, 'index2'])->name('subscriptions.indexClient');
    Route::get('/products/{product}', [ProductController::class, 'show'])->name('products.show');
});
...
// Route::get('/products/admin', [ProductController::class, 'index'])->name('products.indexAdmin');
