...
@section('content')
    <div class="p-6">
        ...
        <div class="w-full flex flex-col items-center gap-6  lg:w-full lg:flex-row justify-between  ">

            <a href="{{ route('products.create') }}"
                class="bg-red-800 hover:bg-red-600 text-white font-bold py-2 px-4 rounded mt-2">Créer
            ...
            <select id="categoryFilter"
                class=" flex items-center lg:flex items-center  justify-center  w-2/5 lg:w-1/5 mt-1 p-2 border border-gray-300 bg-white rounded-md shadow-sm mt-2 ">
            ...
            <form id="searchForm" class="flex items-center justify-center mt-2">
                    ...
                    <div class="bg-white  shadow-lg overflow-hidden transform hover:scale-105 transition duration-300">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex justify-between items-center">
                                <div>
                                    <p class="text-gray-800 font-semibold">Price: ${{ number_format($product->price, 2) }}
                                    </p>
                                    ...
                                    <a href="{{ route('products.edit', $product->id) }}">
                                        <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <g id="SVGRepo_iconCarrier">
                                                ...
                                                <path d="M21 21H12" stroke="#909090" stroke-width="1.5"
