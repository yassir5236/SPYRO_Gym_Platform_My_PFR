        ...
        <div class="lg:col-span-1">
            ...
            @foreach ($subscriptionRequests as $request)
                ...
                <div class="relative bg-white py-6 px-6 rounded-3xl w-64 my-4 shadow-xl">
                    ...
                    <div class="mt-8">
                        <p class="text-xl font-semibold my-2">{{ $request->user->name }}</p>
                        <div class="flex space-x-2 text-gray-400 text-sm">
                            ...
                            <p>Type: {{ $request->subscription_type }}</p>
                        </div>
                        <div class="flex space-x-2 text-gray-400 text-sm my-3">
                            ...
                            <p>Price: {{ $request->subscription->price }} $</p>
                        </div>
                        <div class="border-t-2"></div>

                        <div class="flex justify-between">
                            <div class="my-2">
                                <p class="font-semibold text-base mb-2">Reject</p>
                            ...
                            <div class="my-2">
                                <p class="font-semibold text-base mb-2">Approve</p>
