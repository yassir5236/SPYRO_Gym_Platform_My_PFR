    ...
    <div class="flex flex-col px-5 text-xl font-medium">
            ...
            <div class="flex content-end gap-5 items-center w-full max-md:flex-wrap max-md:max-w-full mt-5 ">
                ...
                <div id="burger-menu-list" class="hidden lg:flex gap-5 justify-between">
                        ...
                        @guest
                            ...
                            <div
                            style="background-color: rgb(194 65 12);" class=" text-white p-2 px-8 rounded-md ">
        ...
        <div class="flex overflow-hidden relative flex-col items-center px-16 pt-16 pb-6 min-h-[411px] z-30 max-md:px-5">
            ...
            <div class="flex relative flex-col items-center w-full max-w-[1200px] max-md:max-w-full">
                ...
                <div class="mt-12 text-xl font-medium leading-8 text-center text-white text-opacity-80 max-w-[876px] max-md:mt-10 max-md:max-w-full">
                ...
                <div class="flex gap-4 mt-9">
                    <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/3aca9be230183a2a6898520776404b0331eb1332818a1bc2f8239136694eedc1?" class="shrink-0 aspect-square w-9 max-md:w-7" />
                    <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/9b20cd0d4b798f46fd0632946f2b31333a4503105cc5cce8baefe56247ab9b0a?" class="shrink-0 aspect-square w-9 max-md:w-7" />
                    <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/a21e7ea4312026044cd9da9b1b10040d65a9d22e1ddc94a9aa112719b65e5ddd?" class="shrink-0 aspect-square w-9 max-md:w-7" />
                    <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/3e285806a368101f59320414abc2af9fa0ed975c2ebf6502617b0f19a4440da3?" class="shrink-0 aspect-square w-9 max-md:w-7" />
                </div>
