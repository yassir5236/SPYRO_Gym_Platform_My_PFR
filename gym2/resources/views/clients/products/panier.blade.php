...
@section('content')
    ...
    <div class="mt-10"
        ...
        <div
            style="position: absolute; top: 60%; left: 43%; transform: translate(-50%, -50%); text-align: center; border-radius: 25px;">
            <p style="font-size: 40px; color: white;">Keep calm and make a shop from <span
                    class="text-red-600 font-semibold">SPYRO</span></p>
        </div>
    </div>
            ...
            <button class="text-white">
                <svg class="w-6 h-6 fill-current" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd"
                        d="M5.707 5.293a1 1 0 0 1 1.414-1.414L10 8.586l2.879-2.88a1 1 0 1 1 1.414 1.414L11.414 10l2.88 2.879a1 1 0 1 1-1.414 1.414L10 11.414l-2.879 2.88a1 1 0 0 1-1.414-1.414L8.586 10 5.707 7.121a1 1 0 0 1 0-1.414z"
