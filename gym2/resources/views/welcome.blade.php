...
@section('content')
    <div class="flex items-center justify-center h-screen">
        <div class="min-w-screen h-full bg-cover"
            ...
            <div
                class="overflow-hidden relative flex-col justify-center self-start px-7 py-4 mt-8 text-xl bg-red-600 text-white aspect-[4.11] rounded-md w-40 max-md:px-5">
